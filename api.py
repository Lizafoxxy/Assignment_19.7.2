...
class PetFriends:
    ...
    def add_new_pet(self, auth_key: json, name: str, animal_type: str, age: int, pet_photo: str) -> json:
        """Метод отправляет запрос на сервер о создании карточки нового питомца по указанным в методе данным  и
        возвращает статус запроса и htpekmnfn в формате JSON с данными добавленного питомца"""
        data = {
               'name': name,
    ...
    def add_photo_of_pet(self, auth_key: json, pet_id: str, pet_photo: str) -> json:
        """ Методо добавляет фото для уже занесенного в базу питомца"""
